...
public class V_AllCourses extends AndroidViewModel {

    public MutableLiveData<R_courses_news> mLive = new MutableLiveData<>();

    public V_AllCourses(@NonNull Application application) {
        super(application);
    }

    //GET R_courses_news total which includes List<Data_of_course> courses & List<Data_of_news> news  (all).
    ...
    public void post_watchLater(S_Add_watchLater addition)
    {
        ...
        //هكتب في الparameter كل واحدة على حدا
    }
