...
public class V_OnlineCourses extends AndroidViewModel {

    public MutableLiveData<R_courses_news> mLive = new MutableLiveData<>();

    public V_OnlineCourses(@NonNull Application application) {
        super(application);
    }

    //GET R_courses_news total which includes List<Data_of_course> courses & List<Data_of_news> news (online).
